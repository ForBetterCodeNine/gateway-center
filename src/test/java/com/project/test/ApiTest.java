...
public class ApiTest {
    ...
    public void test_registerGatewayServerNode() {
        configManageService.registryGatewayServerNode("10001", "api-gateway-g1", "电商支付网关", "127.0.0.196");
        configManageService.registryGatewayServerNode("10001", "api-gateway-g2", "电商支付网关", "127.0.0.197");
        configManageService.registryGatewayServerNode("10001", "api-gateway-g3", "电商配送网关", "127.0.0.198");
    }
